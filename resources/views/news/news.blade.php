            ...
            <div class="col-md-4">
                ...
                <div data-aos="flip-up">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="/storage/news_img_sm/{{ $each_news->img }}" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">{{$each_news->title}}</h5>
                            <p class="card-text">{{$each_news->body}}</p>
                            <a href="/news/{{$each_news->id}}/show" class="btn btn-primary">Посмотреть Новость</a>
                        </div>
                    </div>
                </div>
            </div>
